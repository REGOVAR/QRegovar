...
GenericScreen
{
    ...
    Text
    {
        ...
        text: qsTr("It's almost done ! Give a name and set in which project you want to save your analysis. Below a summary of the configuration of the analysis.\nIf all is good. press the \"Launch\" button. The Regovar server will prepare your data, and then you will be able to dynamically filter.")
