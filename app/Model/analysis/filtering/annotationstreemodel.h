...
public:
    ...
    bool loadJson(const QJsonObject& data, QStringList dbUids);
    void addEntry(const QString& dbName, const QString&  dbVersion, const QString& dbDescription, bool isDbSelected, FieldColumnInfos* data);
    void setupModelData(const QJsonArray& data, TreeItem *parent, const QStringList& dbUids);
